...
const main = async function () {
  const contract = await (await hre.ethers.getContractFactory('TestNetMint')).deploy()
  await contract.deployed();

  await verify('TestNetMint', contract.address)
  ...
  deploy.TestNetMint = contract.address
