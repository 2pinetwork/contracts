// File cloned from https://github.com/jamestalmage/istanbul-combine/blob/872323fdee32df3d99e5e62279d20a7f31da64fc/index.js
// And adapted to use sc-istanbul instead of old istanbul
var fs = require('fs');
var glob = require('glob');
var Q = require('q');
var readFile = Q.denodeify(fs.readFile);
const { Collector, Report } = require('sc-istanbul')
