...
slither . --json slither-analysis$(date +"%s").json --exclude-informational --exclude-low --exclude name-reused --filter-paths "Archimedes.sol,ControllerAaveStrat.sol,Controller.sol,FeeManager.sol,MintAndDeposit.sol,PiToken.sol,PiVault.sol,Referral.sol"
